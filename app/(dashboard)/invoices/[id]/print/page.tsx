  ...
  const buildPrintHTML = useCallback(() => {
    ...
    const css = `
      <style>
        ...
        thead th:first-child { ${verticalBorderWidth > 0 ? `border-left:${verticalBorderWidth}px solid ${verticalBorderColor};` : ''} }
        tbody td { border-bottom:${borderWidth}px solid ${borderColor}; }
        tbody td:first-child { ${verticalBorderWidth > 0 ? `border-left:${verticalBorderWidth}px solid ${verticalBorderColor};` : ''} }
